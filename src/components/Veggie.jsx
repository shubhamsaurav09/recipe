  ...
  const getVeggie = async () => {
    ...
    if (check) {
      ...
      const api = await fetch(
        `https://api.spoonacular.com/recipes/random?apiKey=${process.env.REACT_APP_API_KEY}&number=9&tags=vegetarian` // fetch recipe from api (number=9 restricts only 9 results)
